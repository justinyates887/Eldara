...
**After Combat:** The camp contains crucial intelligence about the planned attack on [[Greendale]]:

**The Command Table:**

- **Maps of [[Greendale]]:** Detailed layouts showing guard positions, patrol routes, and key buildings
...
- **Correspondence:** Letters from unknown contacts in other towns
- **Payment Records:** Gold pieces and promissory notes showing this isn't their first job
- **Personal Effects:** Items identifying the captain as "Gareth Blackthorn" (possibly related to other regional bandit activity)

## Captured Intelligence

**Critical Information Discovered:**

- **Timeline:** The attack is planned for dawn tomorrow (creating immediate urgency)
- **Target Priority:** Primary goal is the bank vault, secondary targets are wealthy merchant quarters
- **Escape Route:** Planned retreat north through **Gloamwood Forest** to predetermined rendezvous
- **Personnel Count:** This represents the full bandit force—no additional reinforcements

**Strategic Intelligence:**

- **Inside Information:** Someone in [[Greendale]] has been providing intelligence (maps are too detailed otherwise)
